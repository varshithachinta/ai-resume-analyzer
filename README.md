...
**[➡️ Try it live on Streamlit Cloud](https://your-app-url.streamlit.app)**  
...
│   ├── main.py                    # Entry point
│   ├── pages/
│   │   ├── 01_analyze.py          # Resume upload & analysis page
│   │   ├── 02_insights.py         # Market insights & skill comparison
...
│   └── utils/
│       └── nlp_utils.py           # Skill extraction, NLP helpers
├── data/
│   └── job_descriptions/
